 ...
 * @author Pichau
 */
public class AltUsuario extends javax.swing.JFrame {

    /**
     * Creates new form AltUsuario
     */
    public AltUsuario() {
        initComponents();
    }
    ...
    public void resgate(String nome, String sexo, String telefone, String dt_nascimento, String codigo) {
        campoNome.setText(nome);
        campoTelefone.setText(telefone);
        comboSexo.setSelectedItem(sexo);
        campoDtNasc.setText(dt_nascimento);
        codigoGlobal = codigo;
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Alterar Usuários:");
    ...
    private void btAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAlterarActionPerformed
        ...
        if(nome_usuario.isEmpty() || telefone.isEmpty() || dt_nasc.isEmpty() ) {
            ...
            DAO.DAO_Usuario objUser = new DAO_Usuario();
            Model.Usuario usuario = new Usuario(nome_usuario, sexo, telefone, dt_nasc, codigoGlobal);
            
            try{
                objUser.altera(usuario);
                campoNome.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AltUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AltUsuario().setVisible(true);
            }
        });
    }
