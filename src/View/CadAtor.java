 ...
 * @author erikv
 */
public class CadAtor extends javax.swing.JFrame {

    /**
     * Creates new form CadAtor
     */
    public CadAtor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("LoucaDora - Cadastrar Ator");
        setResizable(false);
        ...
        jLabel7.setText("Cadastrar Ator:");
    ...
    private void btCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCadastrarActionPerformed
        ...
        if(nome_ator.isEmpty() || dt_nasc.isEmpty()) {
            ...
            Model.Atores ator = new Atores(nome_ator, sexo, dt_nasc);
            
            try{
                objAtor.adiciona(ator);
                JOptionPane.showMessageDialog(this, "Ator inserido com sucesso!");
                campoNome.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadAtor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
